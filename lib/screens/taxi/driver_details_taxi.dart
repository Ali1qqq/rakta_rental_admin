...
class TaxiDriverScreen extends StatelessWidget {
  final ({String driverName, String a, String b, String status}) record;
   TaxiDriverScreen({super.key , required this.record});
  @override
          ...
          Row(
            children: [
              SvgPicture.asset(
                ...
                height: 30,
                width: 30,
                color: fileInfo.provider == "Taxi"
                    ? primaryColor.withOpacity(0.5)
                    : fileInfo.provider == "Bus"
                        ? Colors.cyan
                        : Colors.green,
              ),
              Padding(
