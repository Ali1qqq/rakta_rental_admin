    ...
    return Scaffold(
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
            Text("Send Notification",style: TextStyle(color: Colors.white,fontSize: 30),),
            SizedBox(height: 50,),
            SizedBox(
              height: 75,
              width: 400,
            ...
            Row(
              children: [
                ...
                SizedBox(width: 5,),
                Text("Send To All User",style: TextStyle(color: Colors.white,fontSize: 22),)
              ],
            ),
            SizedBox(height: 15,),
            Row(
              children: [
                ...
                SizedBox(width: 5,),
                Text("Send with Filter",style: TextStyle(color: Colors.white,fontSize: 22),)
              ],
            ),
            SizedBox(height: 25,),
            IgnorePointer(
                    ...
                    Row(
                      children: [
                        SizedBox(
                          ...
                          child:  Row(
                            children: [
                              Text("Age of User",style: TextStyle(color: Colors.white,fontSize: 22),),
                              SizedBox(width: 10,),
                              Expanded(
                                child: TextField(
                                  decoration: InputDecoration(
                        ...
                        SizedBox(
                          ...
                          child:  Row(
                            children: [
                              Text("Gender",style: TextStyle(color: Colors.white,fontSize: 22),),
                              SizedBox(width: 10,),
                              Expanded(
                    ...
                    Row(
                      children: [
                        SizedBox(
                          ...
                          child:  Row(
                            children: [
                              Text("Payment Range",style: TextStyle(color: Colors.white,fontSize: 22),),
                              SizedBox(width: 10,),
                              Expanded(
                                child: TextField(
                                  decoration: InputDecoration(
                        ...
                        SizedBox(
                          ...
                          child:  Row(
                            children: [
                              Text("Location",style: TextStyle(color: Colors.white,fontSize: 22),),
                              SizedBox(width: 10,),
                              Expanded(
